...
if (isset($_GET['cari'])) {
    ...
    $query = "SELECT * FROM barang WHERE nama_barang LIKE '%$search%' OR kode_barang LIKE '%$search%' OR kategori LIKE '%$search%' ORDER BY id DESC";
} else {
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
        ...
        .btn-cari { padding: 8px 15px; background-color: #2e7d32; color: white; border: none; border-radius: 4px; cursor: pointer; }
...
<body>
    ...
    <div class="main-content">
        <div class="header"><h1>Daftar Informasi Stok (Staf)</h1></div>
